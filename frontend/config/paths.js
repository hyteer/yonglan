...
module.exports = {
  ...
  appBuildDev: resolveApp('build/prod'),
  appPublic: resolveApp('public'),
  appHtml: resolveApp('public/erp.html'),
  ...
  demoRouteJs:resolveApp('src/demo/routeOrg/index.js'),
  demoRouteHtml: resolveApp('src/demo/routeOrg/index.html'),
  /***************** Demo *******************/
